...
//=============================================//
// bool FloorRobot::pick_faulty_part(ariac_msgs::msg::Part part_to_pick , int cnt)
// {
//   RCLCPP_INFO_STREAM(get_logger(), "Attempting to pick a "
//                                        << part_colors_[part_to_pick.color]
//                                        << " "
...
//   std::string bin_side;
  ...
  // No need to change gripper as it will be part gripper
...
//=============================================//
// bool FloorRobot::dispose_part(int agv_num, int quadrant, int cnt)
// {
//   if (!floor_gripper_state_.attached)
//   {
//     RCLCPP_ERROR(get_logger(), "No part attached");
...
bool FloorRobot::complete_kitting_task(order_object &order)
{
  ...
  { bool part_picked = false;
    ...
    if (part_picked){
      ...
      //   // if that quadrant is false -> pick_faulty_part(kit_part.part, planning_scene_part_cnt_) - > dispose_part(order.order.kitting_task.agv_number, kit_part.quadrant, planning_scene_part_cnt_) -> remove part from planning scene -> pick_bin_part again
      //   //
      // }
    }
    else{
